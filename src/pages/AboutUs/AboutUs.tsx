    ...
    <div className="py-2">
      ...
      >
        ...
        <p className="md:text-lg mb-8 px-2">
          ...
          service to humanity, Daar Un Noor Sverige envisions a world
          transformed by the profound values enshrined in the Islamic faith.
        </p>
        <p className="md:text-lg mb-8 px-2">
          ...
          thrive. Daar Un Noor Sverige invites you to join us on this meaningful
